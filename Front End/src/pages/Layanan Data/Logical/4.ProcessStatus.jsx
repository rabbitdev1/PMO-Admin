...
import { getPendampinganPengolahanAnalisisDataFinish, getPendampinganPengolahanAnalisisDataProcess, getProduksiDataSitusWebFinish, getProduksiDataSitusWebProcess } from "../data";
...
const ProcessStatus = ({
    ...
    const PendampinganProcess = getPendampinganPengolahanAnalisisDataProcess(inputLocal);
    const PendampinganFinish = getPendampinganPengolahanAnalisisDataFinish(finishData);
                                    ...
                                    <div className="flex flex-1 flex-col gap-3 bg-lightColor dark:bg-cardDark p-3 rounded-lg">
                                        ...
                                        {Object.entries(processData).map(([key, value]) => (
                                            <DynamicShow
                                                ...
                                                type={
                                                    key === "upload_dokumen_hasil_analisa" || key==="upload_file_data_valid"
                                                        ? "pdf"
                                                        : "text"
                                                }
                                            />
                            ...
                            {JSON.parse(authProfile)?.role === "teknis_desiminasi" && (
                                ...
                                <div className="flex flex-1 flex-col gap-3 bg-lightColor dark:bg-cardDark p-3 rounded-lg">
                                    ...
                                    {renderProcessInputs(detailData.submission_title === "Layanan Pendampingan Pengolahan dan Analisis Data" ?
                                        PendampinganProcess :
                                        detailData.submission_title === "Layanan Produksi Data dari Situs Web" ? ProduksiProcess : []
                            ...
                            {JSON.parse(authProfile)?.role === "katim_desiminasi" && (
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <div className="flex flex-1 flex-col gap-3 bg-lightColor dark:bg-cardDark p-3 rounded-lg">
                                        ...
                                        {renderFinishInputs(detailData.submission_title === "Layanan Pendampingan Pengolahan dan Analisis Data" ?
                                            PendampinganFinish :
                                            detailData.submission_title === "Layanan Produksi Data dari Situs Web" ? ProduksiFinish :
                                                []
                                        )}
                                        <DynamicButton
