...
import { getRelokasiAlatProcess, getPenambahanAlatProcess, getPenambahanBandwidthProcess, getTroubleshotingProcess, getRelokasiAlatFinish, getPenambahanBandwidthFinish, getPenambahanAlatFinish, getTroubleshotingFinish, getHostingProcess, getDomainProcess, getDomainFinish, getHostingFinish } from "../data";
                                            ...
                                            PenambahanAlatProcess : detailData.submission_title === "Penambahan Bandwidth" ?
                                                PenambahanBandwidthProcess : detailData.submission_title === "Troubleshooting Aplikasi dan Jaringan" ?
                                                    TroubleshotingProcess : detailData.submission_title === "Hosting" ?
                                                        HostingProcess : detailData.submission_title === "Domain" ?
                                                            DomainProcess
                                                            : []
                                    )}
